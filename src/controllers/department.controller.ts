...
import { genDepartment, getAllDepartment, getDepartmentByName } from "../services/department.service";
...
export async function getDepartmentDetailController(req: Request, res: Response) {
    try {
